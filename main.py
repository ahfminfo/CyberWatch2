...
#pageHeader {
    background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
        stop:0 #1F6FEB, stop:0.5 #388BFD, stop:1 #58A6FF);
    border-radius: 12px;
    padding: 20px;
    color: white;
}
...
class CyberWatchApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("CyberWatch v5.0 - سامانه هوشمند")
    ...
    def create_sidebar(self):
        ...
        self.records_label.setStyleSheet(
            "color: #58A6FF; padding: 15px; font-weight: bold;"
        )
        self.records_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    def update_dashboard(self):
        stats = self.db.get_stats()
        self.records_label.setText(f"کل رکوردها: {stats['total']:,}")
        ...
        cards = [
            ("📦", f"{stats['total']:,}", "کل رکوردها", "#58A6FF"),
            ("📅", str(active_years), "سال فعال", "#3FB950"),
            ("📂", str(len(stats['subjects'])), "موضوعات", "#D29922"),
            ("📱", f"{ph_pct}%", "شماره تماس", "#BC8CFF"),
            ("📸", f"{ig_pct}%", "ایدی اینستا", "#F85149"),
        ]
    ...
    def update_subjects_card(self, stats):
        ...
        for i, (subj, cnt) in enumerate(stats['subjects'][:8]):
            ...
            count.setStyleSheet(f"color: {colors[i % len(colors)]}; font-weight: bold;")
    ...
    def create_search_page(self):
        ...
        self.search_count.setStyleSheet(
            "color: #3FB950; font-weight: bold; padding: 5px;"
        )
    ...
    def do_search(self):
        ...
        self.search_count.setText(f"✅ {len(results)} نتیجه یافت شد")
    ...
    def create_advanced_page(self):
        ...
        for i, field in enumerate(text_fields):
            ...
            inp = QLineEdit()
            inp.setPlaceholderText(f"{field}...")
    ...
    def do_advanced_search(self):
        ...
        self.adv_count.setText(f"✅ {len(results)} نتیجه")
    ...
    def create_list_page(self):
        ...
        self.list_count.setStyleSheet(
            "color: #58A6FF; font-weight: bold; padding: 5px;"
        )
    ...
    def load_list(self):
        ...
        self.list_count.setText(f"📦 {len(all_data)} رکورد")
    ...
    def create_settings_page(self):
        ...
        <h2 style="color: #58A6FF;">🔍 CyberWatch v5.0</h2>
